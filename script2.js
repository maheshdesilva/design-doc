angular.module('app', ['ui.bootstrap', 'ngAnimate'])
    ...
    .controller('main', ['$scope', '$rootScope', 'sortable', function ($scope, $rootScope, sortable) {
        ...
        var items = [
            ...
            {
                'icon': 'm-phone',
                'name': 'Some Mobile Site',
                'date': 'Thursday at 1:27pm',
                'user': {
                    'name': 'Someone',
                    'color': '#456183'
                }
            ...
            {
                'icon': 'm-group',
                'name': 'Kitty Kat Kapture Form',
                'date': 'Wednesday at 7:15pm',
                'user': {
                    'name': 'Kitty',
                    'color': '#1D9D9D'
                }
        ...
        sortable($scope, items, 10, 'updated_at');
